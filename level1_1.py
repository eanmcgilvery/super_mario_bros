...
class Level1_1(Level):
    ...
    def enemy_spawn_triggers(self, enemies):
        ...
        if not self.goomba1:
            self.goomba1 = True
            enemies.add(Goomba(self.settings, self.screen, self.ui, self.timers, self.settings.brick_lenth * 25, self.settings.ground_level - self.settings.goomba_height, 1))
        if not self.goomba2 and self.settings.screen_pos + self.x_spawn_point > self.settings.brick_lenth * 42:
            self.goomba2 = True
            enemies.add(Goomba(self.settings, self.screen, self.ui, self.timers, self.x_spawn_point, self.settings.ground_level - self.settings.goomba_height, 1))
        ...
        if not self.goomba5 and self.settings.screen_pos + self.x_spawn_point > self.settings.brick_lenth * 82:
            self.goomba5 = True
            enemies.add(Goomba(self.settings, self.screen, self.ui, self.timers, self.x_spawn_point, self.settings.ground_level - self.settings.brick_lenth * 8 - self.settings.goomba_height, 1))
        ...
        if not self.koopa1 and self.settings.screen_pos + self.x_spawn_point > self.settings.brick_lenth * 109:
            self.koopa1 = True
            enemies.add(KoopaTroopa(self.settings, self.screen, self.ui, self.timers, self.x_spawn_point, self.settings.ground_level - self.settings.koopa_height, 1))
