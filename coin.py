    ...
    def update_image(self):
        ...
        if self.otype is 1:
            ...
            if self.frame is 1:
                ...
                self.frame = 3
                self.image = pygame.transform.scale(self.pic, (
                    int(self.settings.spin_coin_width), self.settings.spin_coin_height))
            elif self.frame is 3:
                self.pic = pygame.image.load('images/coin3.png')
                self.frame = 1
                self.image = pygame.transform.scale(self.pic,
                                                    (int(self.settings.spin_coin_width), self.settings.brick_lenth))
